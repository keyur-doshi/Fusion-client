...
export const fetchProcessedRoute = (username, designation) => `${host}/research_procedures/api/get-processed/?username=${username}&designation=${designation}`;
export const fetchFileRoute = (fileID) => `${host}/research_procedures/api/get-file/?file_id=${fileID}`;
export const forwardFileRoute = `${host}/research_procedures/api/forward-file/`;
export const fetchFileTrackingHistoryRoute = (fileID) => `${host}/research_procedures/api/get-history/?file_id=${fileID}`;
export const rejectFileRoute = (fileID) => `${host}/research_procedures/api/reject-file/?file_id=${fileID}`;